...
('AAAA','B74A','ITA','PER','2021-07-18 13:00:00','2021-07-19 06:20:00'), --Italia a Peru // 17h 20min
('AAAA','B73J','GTM','URY','2021-10-12 14:20:00','2021-10-13 04:06:00'), --Guatemala a Uruguay // 13h 46min
('AAAA','AA6L','BRA','ESP','2021-11-02 18:00:00','2021-11-03 07:00:00'), --Brasil a España // 13h
('AAAA','AA8A','URY','USA','2021-07-19 19:00:00','2021-07-20 07:31:00'), --Uruguay a Estados Unidos // 12h 31min
('AAAA','E1AE','VEN','PAN','2021-08-05 07:30:00','2021-08-05 09:50:00'), --Venezuela a Panamá // 2h 20min
('AAAA','B7MS','ECU','ITA','2021-09-02 12:00:00','2021-09-03 02:55:00'), --Ecuador a  Italia // 14h 55min
('AAAA','B78A','MEX','NIC','2021-10-04 13:50:00','2021-10-04 19:00:00'), --Mexico a Nicaragua // 6h
('AAAA','A77K','NIC','VEN','2021-07-03 16:00:00','2021-07-03 20:16:00'), --Nicaragua a Venezuela // 4h 16min
('AAAA','A32X','PAN','MEX','2021-07-12 20:00:00','2021-07-13 00:05:00'); --Panamá a Mexico // 4h 5min
...
('AAA','AAAA','DUE','YYYY-MMM-DD 99-99-99','A','AAA'),
('AAA','AAAA','BOL','99-99-99','A','AAA'),
('AAA','AAAA','COL','99-99-99','A','AAA'),
('AAA','AAAA','CHL','99-99-99','A','AAA'),
('AAA','AAAA','CRI','99-99-99','A','AAA'),
('AAA','AAAA','ECU','99-99-99','A','AAA'),
('AAA','AAAA','GTM','99-99-99','A','AAA'),
('AAA','AAAA','BRA','99-99-99','A','AAA'),
